...
Triton's themetool is the primary purpose for which the dotfile manager was created to begin with. If you like the freedom of switching between custom themes at will, you may be interested in using this tool often.
